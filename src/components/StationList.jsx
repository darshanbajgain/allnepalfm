  ...
  return (
    <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-3 xl:grid-cols-5 gap-4  lg:gap-6">
      {filteredStations.map((station) => (
        <Card
          key={station.id}
          className="group overflow-hidden rounded-xl transition-all duration-300 hover:shadow-lg flex flex-col"
        >
          <div className="relative flex flex-col lg:flex-row items-center p-4 gap-2 justify-start">
            ...
            <div className="flex items-center justify-between w-full gap-2">
              <Avatar className="h-6 w-6 lg:h-8 lg:w-8 rounded-lg">
                ...
                <AvatarFallback className="rounded-lg text-xs lg:text-sm font-medium bg-primary/90 text-primary-foreground">
          ...
          <CardContent className="p-4 border-t border-border flex flex-col justify-between gap-2">
            <div className="flex items-center justify-between ">
              ...
              <Button
                size="icon"
                variant="outline"
                className="h-10 w-10 px-2 py-2 rounded-full text-white hover:text-primary-foreground hover:bg-primary/50 bg-primary"
